...
int main() {
    ...
    try {
        // Define vectors in C++
        std::vector<int8_t> part0 = {2, 3, 6, 1, 0, 5, 4, 3, 6, 2};
        std::vector<int8_t> part1 = {0, 6, 2, 5, 1, 3, 4, 6, 0, 2};
        ...
        py::array_t<int8_t> np_part0 = py::cast(part0);
        py::array_t<int8_t> np_part1 = py::cast(part1);
