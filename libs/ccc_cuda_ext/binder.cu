...
PYBIND11_MODULE(ccc_cuda_ext, m)
{
    ...
    m.def("ari_int32", &ari<int>, "CUDA version of Adjusted Rand Index (ARI) calculation", "parts"_a, "n_features"_a,
          "n_parts"_a, "n_objs"_a, "batch_start"_a = 0,
          "batch_size"_a = 0); // _a is a shorter notation for named arguments
    m.def("compute_coef", &compute_coef<int16_t, float>, "CUDA version of CCC coefficient calculation",
